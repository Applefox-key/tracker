...
export function usePracticeEntries(mode: PracticeMode, filters: PracticeFilters): Entry[] {
  ...
  return useMemo(() => {
    const base = applyFilters(entries, { selectedRatings, selectedCategory, selectedTag, masteryFilter })
  ...
  }, [entries, mode, ratingsKey, selectedCategory, selectedTag, masteryFilter])
}
