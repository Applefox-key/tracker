...
//   2. Rename VITE_API_URL / VITE_APP_URL env vars if needed.
...
/**
 * Builds the Google OAuth redirect URL for this project's backend.
 * Pass explicit values to override the env-var defaults.
 */
